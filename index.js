...
// selecting all the buttons and loop over to add event listener
...
for (let i = 0; i < numberofDrumButtons.length; i++) {
    ...
    document.querySelectorAll(".drum")[i].addEventListener("click", function () {
        const butttonInnerHTML = this.innerHTML;
...
//function to detect exact key or button 
...
// function to add animation after the button or key has pressed 
